...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSManagedObjectContext * moc = [self managedObjectContext];    // retrive managed object
...
- (PersonMO *)createPersonMO {
    NSManagedObjectContext *moc = [self managedObjectContext];
    PersonMO *PersonMO = [NSEntityDescription insertNewObjectForEntityForName:@"Chore" inManagedObjectContext:moc];
    return PersonMO;
}

- (ChoreLogMO *)createChoreLogMO {
    NSManagedObjectContext *moc = [self managedObjectContext];
    ChoreLogMO *ChoreLogMO = [NSEntityDescription insertNewObjectForEntityForName:@"Chore" inManagedObjectContext:moc];
    return ChoreLogMO;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "DK.CoreData.SimpleCoreData" in the application's documents directory.
